...
class Enclave:
    ...
    def verify(self, verification_pass):
        if verification_pass == "image_base":
            ...
            return self.verify_usercall("close", "void close(uint64_t fd)")
            ...
            return self.verify_usercall("flush", "void flush(uint64_t fd)")
        ...
        elif verification_pass == "launch_thread":
            ...
            return self.verify_usercall("wait", "void wait(uint64_t event, uint64_t timeout)")
